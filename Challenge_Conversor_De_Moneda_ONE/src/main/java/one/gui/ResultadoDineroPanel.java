...
public class ResultadoDineroPanel extends JPanel {

	public interface ResultadoDineroPanelListener {
		void onVolverRDPPressed();
		void onConvertirPressed();
	}
	private ResultadoDineroPanelListener resultadoDineroPanelListener;
	private JLabel lblInput;
	
	public void setResultadoDineroPanelListener(ResultadoDineroPanelListener listener) {
		this.resultadoDineroPanelListener = listener;
	}
	...
	public ResultadoDineroPanel() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				resultadoDineroPanelListener.onVolverRDPPressed();
			}
		});
