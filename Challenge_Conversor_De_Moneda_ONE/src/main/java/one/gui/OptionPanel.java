...
public class OptionPanel extends JPanel {
	...
	public String inputUno (String dinero, int option) {
		String inputUno;
		if(option == 1) {
			 inputUno = dinero+" en peso chileno a Dólar";
			 return inputUno;
		}
		if(option == 2) {
		...
		if(option == 4) {
			inputUno = dinero+" en peso chileno a Yen Japonés";
			return inputUno;
		}
		if(option == 5) {
		...
		if(option == 6) {
			inputUno = dinero+" en Dólar a peso chileno";
			return inputUno;
		}
		if(option == 7) {
		...
		if(option == 9) {
			inputUno = dinero+" en Yen Japonés a peso chileno";
			return inputUno;
		}
		if(option == 10) {
